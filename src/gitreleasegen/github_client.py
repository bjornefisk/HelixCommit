...
DEFAULT_CACHE_DIR = Path(".gitreleasegen-cache/github")
CACHE_VALUE_KEY = "__cache_value__"

CACHE_ENABLED_ENV = "GITRELEASEGEN_GH_CACHE"
CACHE_DIR_ENV = "GITRELEASEGEN_GH_CACHE_DIR"
CACHE_TTL_MINUTES_ENV = "GITRELEASEGEN_GH_CACHE_TTL_MINUTES"
CACHE_TTL_SECONDS_ENV = "GITRELEASEGEN_GH_CACHE_TTL_SECONDS"
RETRY_MAX_ENV = "GITRELEASEGEN_GH_MAX_RETRIES"
RETRY_BASE_ENV = "GITRELEASEGEN_GH_BACKOFF_BASE_SEC"
RETRY_CAP_ENV = "GITRELEASEGEN_GH_BACKOFF_CAP_SEC"
        ...
        self._session.headers.update(
            {
                ...
                "User-Agent": "GitReleaseGenerator/0.1.0",
            }
        )
        if settings.token:
